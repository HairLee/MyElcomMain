...
import com.elcom.myelcom.core.listener.ConversationFragmentCallbackListener;
import com.elcom.myelcom.core.listener.IncomeCallFragmentCallbackListener;
import com.elcom.myelcom.core.listener.OnCallEventsController;
import com.elcom.myelcom.model.db.QbUsersDbManager;
import com.elcom.myelcom.util.Consts;
import com.elcom.myelcom.util.FragmentExecuotr;
...
import com.elcom.myelcom.util.RingtonePlayer;
import com.elcom.myelcom.util.SettingsUtil;
import com.elcom.myelcom.util.Toaster;
import com.elcom.myelcom.util.UsersUtils;
import com.elcom.myelcom.util.WebRtcSessionManager;
import com.elcom.myelcom.view.ui.fragment.AudioConversationFragment;
import com.elcom.myelcom.view.ui.fragment.BaseConversationFragment;
import com.elcom.myelcom.view.ui.fragment.IncomeCallFragment;
import com.elcom.myelcom.view.ui.fragment.VideoConversationFragment;
...
public class CallActivity extends AppCompatActivity implements QBRTCClientSessionCallbacks, QBRTCSessionStateCallback<QBRTCSession>, QBRTCSignalingCallback,
...
//        currentSession.getMediaStreamManager().setVideoCapturer(new QBRTCScreenCapturer(data, null));
    ...
    private void startSuitableFragment(boolean isInComingCall) {
        ...
        Log.e("hailpt"," startSuitableFragment isInComingCall "+isInComingCall);
